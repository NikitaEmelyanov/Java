 ...
 * их среднее арифметическое. Затем, полученное значение записывается в Файл 2. Таким образом в
 * Файле 2 будет находиться 50 вещественных чисел (1000 / 20 = 50).
 * После того, как Файл 2 будет сформирован, необходимо реализовать статический метод
 * printResult(File file). Этот метод должен рассчитать сумму всех вещественных чисел из Файла
 * 2 и вывести её в консоль, отбросив вещественную часть.
 * Пример:
 * Для простоты, в Файле 1 находится 12 целых чисел, а среднее арифметическое рассчитывается для
 * группы из 4 целых чисел.
 *
...
public class Task2 {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        File file1 = new File("/Users/nikitaemelanov/IdeaProjects/Java/src/Marathon/Day16/file1.txt");
        ...
        File file2 = new File("/Users/nikitaemelanov/IdeaProjects/Java/src/Marathon/Day16/file2.txt");
