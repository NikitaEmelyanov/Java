 ...
 * статический метод List<String>parseFileToStringList(), который считывает содержимое этого файла
 * и возвращает список, состоящий из значений имен и возрастов каждого человека. Получить данный
 * список в методе main() и распечатать его в консоль.
...
public class Task2 {
    ...
    public static List<String> parseFileToStringList(){
        File file = new File("/Users/nikitaemelanov/IdeaProjects/Java/src/Marathon/Day14/people.txt");
