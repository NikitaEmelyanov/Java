 ...
 * Заполнить его вручную десятью произвольными числами. Реализовать статический метод printSumDigits
 * (File file), который считает сумму всех чисел в этом файле и выводит ее на экран. Вызвать данный
 * метод в методе main().
...
public class Task1 {
    public static void main(String[] args) {
        File file = new File("/Users/nikitaemelanov/IdeaProjects/Java/src/Marathon/Day14/input.txt");
