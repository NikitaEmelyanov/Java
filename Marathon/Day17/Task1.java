...
* Всего существует 6 различных шахматных фигур: король (англ. king), ферзь (англ. queen), ладья
* (англ. rook), слон (англ. bishop), конь (англ. knight) и пешка (англ. pawn). В нашей программе,
* у каждой шахматной фигуры есть следующие характеристики:
* ● Ценность фигуры - вещественное число
* ● Строковое обозначение фигуры
* В нашем перечислении необходимо создать 12 фигур - 6 белых и 6 черных. Названия фигур в
* перечислении должны иметь следующий вид:
...
* Ферзь (черный) ♛
* Король (черный) ♚
* Используя созданный enum, в методе main() класса Task1 создайте массив, содержащий 4 белых пешки
* и 4 черных ладьи. Выведите содержимое этого массива на экран, используя строковые обозначения
* шахматных фигур.
